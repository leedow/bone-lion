<template>
	 <div :class="[size.divsize, underline]">
	 	...
	 	<div :class="[icon.css, state]" style="line-height:1;background:#fff">
	 		<textarea :class="[formControl, label.css, 'bo-textarea']" name="{{name}}"  rows="3" @focus="focus" @blur="blur" v-model="val">{{val}}</textarea>
